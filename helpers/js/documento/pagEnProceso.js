        ...
        function(data){
            ...
            if(result[0]){
                ...
                if(accordion_content == '')
                    accordion_content = "Por el momento no tiene documentos en proceso. Para empezar un nuevo documento, elija la opcion Documentos > Nuevo en el menu principal."
